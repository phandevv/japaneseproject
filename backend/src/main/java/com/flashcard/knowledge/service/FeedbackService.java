...
public class FeedbackService {
    ...
    private final com.flashcard.user.repository.UserRepository userRepository;

    public FeedbackService(FeedbackRepository repository, NotificationService notificationService, com.flashcard.user.repository.UserRepository userRepository) {
    ...
    public Feedback save(Feedback feedback) {
        ...
        // Notify all admins
        java.util.List<com.flashcard.user.model.User> admins = userRepository.findByRole("ADMIN");
        for (com.flashcard.user.model.User admin : admins) {
