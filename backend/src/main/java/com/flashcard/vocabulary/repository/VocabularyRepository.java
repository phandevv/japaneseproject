...
public interface VocabularyRepository extends JpaRepository<Vocabulary, Long> {
    ...
    java.util.Optional<Vocabulary> findFirstByKanjiAndCategory(String kanji, String category);

    java.util.Optional<Vocabulary> findFirstByHiraganaAndCategory(String hiragana, String category);
