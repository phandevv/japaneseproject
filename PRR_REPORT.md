...
- [x] **Khắc phục lỗi định tuyến Frontend (Router)**: Chuyển đổi cơ chế định tuyến từ dùng state trong [App.jsx](file:///c:/Users/bbqdd/Documents/_my/japaneseproject/frontend/src/App.jsx) sang sử dụng thư viện **React Router** để phục hồi hoạt động chuẩn của nút Back/Forward và hỗ trợ chia sẻ link trực tiếp (Deep Linking).
